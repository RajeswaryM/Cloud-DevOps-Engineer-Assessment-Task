...
variable "create_vpc_endpoints" {
  description = "(Optional) Indicates whether to create vpc endpoints ."
  type        = bool
  default     = true
}
...
variable "eks_control_plane_subnets" {
  description = "A list of EKS control plane subnets inside the VPC"
  type        = list(string)
  default     = []
}

variable "eks_pod_subnets" {
  description = "A list of EKS pod subnets inside the VPC"
  type        = list(string)
  default     = []
}

variable "eks_pod_subnet_suffix" {
  description = "Suffix to append to eks pod subnets name"
  type        = string
  default     = "eks-pod-k8s"
}
